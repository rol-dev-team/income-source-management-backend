...
class RentalHouseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $source = RentalHouse::paginate($pageSize);
    ...
    {
        if (RentalHouse::where('house_name', $request->input('house_name'))->exists()) {
            return response()->json([
                'status' => false,
        ...
        $source = RentalHouse::create($request->all());
